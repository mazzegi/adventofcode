...
import (
	...
	"github.com/mazzegi/adventofcode/adventofcode_2020/seats"
)

func main() {
	buf := bytes.NewBufferString(input)
	m, err := seats.ParseMap(buf)
	if err != nil {
		panic(err)
	}
	fmt.Printf("*** Map ***\n%s\n", m.String())
	...
	// 	changes := m.NextByAdj()
	// 	fmt.Printf("*** Round %d (occupied=%d) (changes=%d) ***\n%s\n\n", i+1, m.OccupiedSeats(), changes, m.String())
	// 	if changes == 0 {
	// 		break
	// 	}
	// }
